...
BOT_DATA_DIR = joinpath(BASEDIR, 'data')
...
BOT_EXTRA_PLUGIN_DIR = joinpath(BASEDIR, 'plugins')
...
BOT_LOG_FILE = joinpath('jutibot.log')
...
#
# Set environment variable BOT_ADMINS to the list of admins, separated by whitespace.
BOT_ADMINS = tuple([int(x) for x in env['BOT_ADMINS'].split(None)])
